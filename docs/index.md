...
[![License:
MIT](https://img.shields.io/badge/license-MIT-green.svg)](https://dai540.github.io/NestedWGCNA/LICENSE)

`NestedWGCNA` is a computation-first R package for two-stage gene
co-expression analysis. This release is intentionally minimal: it
focuses on network construction, module discovery, and nested
decomposition only.
...
- `mode = "python_compat"`: adjacency `|r|`, dissimilarity
  `sqrt(1 - |r|)`
